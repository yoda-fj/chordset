...
const SAMPLE_URLS = {
  ...
  'F#1': '/samples/drums/hihat-closed/V01-Hats-CLD.wav',
  'A#1': '/samples/drums/hihat-closed/V01-Hats-OP.wav',
  'C2': '/samples/drums/crash/14-Crash-V01-SABIAN-14.wav',
  'D2': '/samples/drums/ride/V01-Ride-22.wav',
  'E2': '/samples/drums/tom/V01-TFlam-12.wav',
  'F2': '/samples/drums/tom/V01-TFlams-10.wav',
  'G2': '/samples/drums/tom/V01-TFlams-13.wav',
}
