...
## 🎼 Fase 2 — A Cifra (CONCLUÍDA 2026-09-09, branch `fase-2-cifra`)
...
- [x] **2.6 Testes de componente** (Onda 3): Testing Library + jsdom + user-event; 12 testes cobrindo alinhamento estrutural acorde/sílaba, transposição via stepper, zoom com travas 20/64, aria-labels, empty state. Setup: `vitest.setup.ts` com cleanup manual (globals:false)

**Gate Onda 3 (fecha a fase):** lint:ci ✅ · tsc ✅ · **105/105 testes** ✅ (93 + 12 de componente)
